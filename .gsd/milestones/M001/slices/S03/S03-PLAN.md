...
**Goal:** Make 8sync bg set print a clear confirmed path + reload outcome, and ensure the WezTerm window updates in-place without requiring a tab reopen.
**Demo:** After this: # S03: bg set Instant Reload Confirmation — UAT
...
## Tasks
- [x] **T01: Fixed Try-ReloadWezTerm to use list-clients probe, added bg set filename confirmation, and added download progress to Save-BgFromUrl** — 
  - Files: modules/bg.ps1
  - Verify: pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -Command "& wezterm cli --help 2>&1"
