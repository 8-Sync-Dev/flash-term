...
function Register-8SyncCompleter {
    ...
    $modes = @('help','status','reload','sync','clean','gpu','bg','hx','theme','opencode','forge','gsd','gsd-1','gguf','remove')
        ...
        $subMap = @{
            ...
            forge    = @('install','update','zsh','enter','zsh-enter','zsh-usage','usage','sync-to-gsd','sync','status','login','provider','uninstall','remove','help','--force','--dry-run','--with-zsh','--skip-omz','--name')
