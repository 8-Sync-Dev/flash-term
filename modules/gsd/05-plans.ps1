...
function Show-GsdPlans {
    ...
    Write-HintRow '  --use-model=sonnet'          'Sonnet only: single model, simplest behavior'
    Write-HintRow '  --tier=light'                'Budget mode: cheapest model leads, expensive as fallback'
